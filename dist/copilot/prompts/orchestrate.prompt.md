...
---
Act as the **orchestrate** agent specified below. Task: ${input:task}
If no task is given, ask for one. Follow the agent's Output Contract and end with the [Companion] next-steps block.
