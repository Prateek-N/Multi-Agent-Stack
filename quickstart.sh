...
echo ""
echo "    $PY agents-maker/context_loaders/project_summary.py"
echo "    $PY agents-maker/context_loaders/repo_tree.py"
echo "    $PY agents-maker/context_loaders/file_chunker.py --files src/main.py src/auth.py"
echo ""
